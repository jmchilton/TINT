...
public class ScaffoldReportParserImplTest {
  ...
  public void testScaffoldReportParse() {
    ...
    final List<ScaffoldEntry> entries = parser.parse(new InputStreamReader(ProteomicsTests.getResourceAsStream("test_report.xls")));
    final ScaffoldEntry entry1 = entries.get(0);
