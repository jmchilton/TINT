...
public class DTAListWriterImpl implements DTAListWriter {

  public List<String> writeFiles(final Directory directory, final DTAList dtaList) {
    return DTAUtils.writeDTAFiles(directory, dtaList);
  }
