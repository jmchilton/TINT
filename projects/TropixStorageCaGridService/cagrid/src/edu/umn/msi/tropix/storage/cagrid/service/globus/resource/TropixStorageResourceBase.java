 ...
 * 
 */
@SuppressWarnings("all") public abstract class TropixStorageResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(TropixStorageResourceBase.class);

	private TropixStorageResourceConfiguration configuration;
    ...
    public TropixStorageResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((TropixStorageResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(TropixStorageConstants.SERVICEMETADATA);
	...
	public TropixStorageResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (TropixStorageResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((TropixStorageResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
