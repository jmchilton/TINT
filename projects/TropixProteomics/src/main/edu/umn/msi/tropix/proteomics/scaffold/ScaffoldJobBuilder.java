...
package edu.umn.msi.tropix.proteomics.scaffold;
...
public interface ScaffoldJobBuilder {
  FileJobProcessor<ExecutableJobDescription> createScaffoldJob(JobProcessorConfiguration config, Scaffold scaffoldInput, Iterable<InputContext> downloadContexts);
}
