...
public interface ITraqQuantitationJobQueueContext extends FileJobQueueContext {
  void submitJob(TransferResource[] mzxmlInputs, TransferResource dataReport, QuantificationType quantificationType, @Nullable QuantificationWeights weights, CredentialResource delegatedReference);

  void submitTrainingJob(TransferResource[] mzxmlInputs, TransferResource dataReport, QuantificationType quantificationType, QuantificationTrainingOptions training, CredentialResource delegatedReference);
