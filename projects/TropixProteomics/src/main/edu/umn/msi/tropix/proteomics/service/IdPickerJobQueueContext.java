...
public interface IdPickerJobQueueContext extends FileJobQueueContext {
  void submitJob(TransferResource[] pepXMLReferences, TransferResource databaseReference, CredentialResource dcReference, IdPickerParameters idPickerParameters);
}
