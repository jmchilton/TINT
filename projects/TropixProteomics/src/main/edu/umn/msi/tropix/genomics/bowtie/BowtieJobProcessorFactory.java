...
package edu.umn.msi.tropix.genomics.bowtie;
...
public interface BowtieJobProcessorFactory {
  FileJobProcessor<ExecutableJobDescription> createBowtieJob(JobProcessorConfiguration config, BowtieInput bowtieInput, InputContext indexContext, Iterable<InputContext> databaseContexts);
}
