...
package edu.umn.msi.tropix.proteomics.idpicker;
...
public interface IdPickerJobProcessorFactory {

  FileJobProcessor<ExecutableJobDescription> create(JobProcessorConfiguration configuration, IdPickerParameters idPickerParameters,
      InputContext databaseContext, Iterable<InputContext> pepXmlContexts);
