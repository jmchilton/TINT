...
package edu.umn.msi.tropix.proteomics.convert;
...
public interface ProteomicsConvertJobFactory {

  JobProcessor<InProcessJobDescription> create(JobProcessorConfiguration config, InputContext sourceContext, ConvertParameters convertParameters);
