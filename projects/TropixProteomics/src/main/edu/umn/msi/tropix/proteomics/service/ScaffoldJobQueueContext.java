...
public interface ScaffoldJobQueueContext extends FileJobQueueContext {
  void submitJob(TransferResource[] references, CredentialResource dcReference, Scaffold scaffoldInput);
}
