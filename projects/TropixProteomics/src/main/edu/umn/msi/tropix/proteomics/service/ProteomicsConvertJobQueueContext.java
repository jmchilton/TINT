...
public interface ProteomicsConvertJobQueueContext extends FileJobQueueContext {
  void submitJob(TransferResource rawFile, CredentialResource delegatedReference, ConvertParameters convertParameters);
}
