...
public interface RawExtractJobQueueContext extends FileJobQueueContext {
  void submitJob(TransferResource rawFile, CredentialResource delegatedReference, String parameters, String rawFileBaseName);
}
