...
package edu.umn.msi.tropix.genomics.service;
...
public interface BowtieJobQueueContext extends FileJobQueueContext {
  void submitJob(TransferResource bowtieIndex, TransferResource[] databases, CredentialResource delegatedReference, BowtieInput bowtieInput);
}
