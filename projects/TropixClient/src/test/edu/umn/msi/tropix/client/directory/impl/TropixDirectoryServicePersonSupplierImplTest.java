...
public class TropixDirectoryServicePersonSupplierImplTest {

  @Test(groups = "unit")
  public void getPersonMap() {
    final Credential credential = Credentials.getMock();
    TropixDirectoryServicePersonSupplierImpl iterable = new TropixDirectoryServicePersonSupplierImpl();
