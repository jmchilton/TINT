...
public class CaGridTransferResource  extends edu.umn.msi.tropix.transfer.types.TransferResource  implements java.io.Serializable {
    private org.cagrid.transfer.context.stubs.types.TransferServiceContextReference transferServiceContextReference;

    public CaGridTransferResource() {
    }
    ...
    /**
     * Gets the transferServiceContextReference value for this CaGridTransferResource.
     * 
    ...
    /**
     * Sets the transferServiceContextReference value for this CaGridTransferResource.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CaGridTransferResource)) return false;
        CaGridTransferResource other = (CaGridTransferResource) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CaGridTransferResource.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://msi.umn.edu/tropix/transfer", "CaGridTransferResource"));
