 ...
 * 
 * This class is a hack until we update to a newer version of hibernate.
 * 
 */
/* CHECKSTYLE:OFF */
public class H2Dialect extends Dialect {
    ...
    public H2Dialect() {
        ...
        try {
            ...
            Integer build = (Integer) constants.getDeclaredField(
                    "BUILD_ID").get(null);
        ...
        registerFunction("cos", new StandardSQLFunction("cos",
                Hibernate.DOUBLE));
        registerFunction("compress", new StandardSQLFunction(
                "compress", Hibernate.BINARY));
        ...
        registerFunction("position", new StandardSQLFunction(
                "position", Hibernate.INTEGER));
        registerFunction("rawtohex", new StandardSQLFunction(
                "rawtohex", Hibernate.STRING));
        ...
        registerFunction("datediff", new StandardSQLFunction(
                "datediff", Hibernate.INTEGER));
