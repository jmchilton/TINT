...
/**
 * Utilities for creating {@link InterruptableExecutor}s. The default {@link InterruptableExecutor} just
 * ignores {@link InterruptionException}s.
 * 
 * @author John Chilton
 *
 */
public class InterruptableExecutors {
  
  public static InterruptableExecutor getDefault() {
