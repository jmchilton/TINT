...
interface ExecutionRunnable extends Runnable {
  void setExecutionCallback(ExecutionCallback executionCallback);

  void setExecutionHook(ExecutionHook executionHook);
}
