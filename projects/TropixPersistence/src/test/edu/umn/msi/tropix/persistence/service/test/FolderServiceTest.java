...
public class FolderServiceTest extends ServiceTest {
  ...
  public void testGetOrCreateVirtualPath() {
    ...
    final VirtualFolder lastFolder = folderService.getOrCreateVirtualPath(tempUser.getCagridId(), rootVirtualFolder.getId(), new String[] {"moo", "cow"});
    ...
    final VirtualFolder lastFolder2 = folderService.getOrCreateVirtualPath(tempUser.getCagridId(), rootVirtualFolder.getId(), new String[] {"moo", "cow2"});
  ...
  public void contents() {
    ...
    assert folderService.getFolderContents(newUser.getCagridId(), root.getId(), new TropixObjectTypeEnum[] {TropixObjectTypeEnum.FOLDER, TropixObjectTypeEnum.SAMPLE}).length == 0;
    ...
    assert folderService.getFolderContents(newUser.getCagridId(), root.getId(), new TropixObjectTypeEnum[] {TropixObjectTypeEnum.FOLDER, TropixObjectTypeEnum.SAMPLE}).length == 3;
    ...
    assert folderService.getFolderContents(newUser.getCagridId(), root.getId(), new TropixObjectTypeEnum[] {TropixObjectTypeEnum.FOLDER}).length == 3;
    assert folderService.getFolderContents(newUser.getCagridId(), root.getId(), new TropixObjectTypeEnum[] {TropixObjectTypeEnum.FOLDER, TropixObjectTypeEnum.SAMPLE}).length == 4;
