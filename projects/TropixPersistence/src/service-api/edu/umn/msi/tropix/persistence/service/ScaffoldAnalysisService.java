...
public interface ScaffoldAnalysisService {

  @PersistenceMethod
  ScaffoldAnalysis createScaffoldJob(@UserId String userId, @Nullable @Modifies String destinationId, ScaffoldAnalysis scaffoldAnalysis,
      @Reads String[] idAnalysisIds, @Modifies String inputFileId, @Modifies String outputFile, final String scaffoldVersion);
