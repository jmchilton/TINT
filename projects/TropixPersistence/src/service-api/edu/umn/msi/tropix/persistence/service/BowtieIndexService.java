...
public interface BowtieIndexService {

  @PersistenceMethod BowtieIndex createBowtieIndex(@UserId String userGridId, @Nullable @Modifies String destinationId, BowtieIndex bowtieIndex, @Modifies String bowtieIndexFile);
