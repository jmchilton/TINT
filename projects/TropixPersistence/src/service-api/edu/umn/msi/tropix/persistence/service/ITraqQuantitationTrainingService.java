...
public interface ITraqQuantitationTrainingService {
  @PersistenceMethod
  ITraqQuantitationTraining createQuantitationTraining(@UserId String userId, @Nullable @Modifies String destinationId, ITraqQuantitationTraining quantitationTraining, @Modifies String dataReportId, @Reads String[] inputRunIds, @Reads String outputFileId);
}
