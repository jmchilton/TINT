...
public interface FileTypeService {
  ...
  @PersistenceMethod FileType[] listFileTypes(@UserId final String userId);

  @PersistenceMethod FileType load(@UserId final String userId, final String fileTypeId);

  @PersistenceMethod FileType loadPrimaryFileTypeWithExtension(@UserId final String userId, final String extension);
