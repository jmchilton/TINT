...
public interface BowtieAnalysisService {

  @PersistenceMethod 
  BowtieAnalysis createBowtieAnalysis(@UserId String userGridId, @Nullable @Modifies String destinationId, @Reads String bowtieIndex, BowtieAnalysis analysis, @Reads String[] databaseIds, @Modifies String outputFileId);
