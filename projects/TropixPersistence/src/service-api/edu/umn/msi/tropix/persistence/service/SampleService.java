...
public interface SampleService {
  ...
  @PersistenceMethod TissueSample createTissueSample(@UserId String userGridId, @Modifies String folderId, TissueSample sample);

  @PersistenceMethod ProteomicsRun[] getProteomicsRuns(@UserId String userGridId, @Reads String tissueSampleId);
}
