...
public interface BaseJobProcessor<T extends JobDescription> extends InitializableJobProcessor<T>, FileJobProcessor<T> {

  void setStagingDirectory(StagingDirectory stagingDirectory);
