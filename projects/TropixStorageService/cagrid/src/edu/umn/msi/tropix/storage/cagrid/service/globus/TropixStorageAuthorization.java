 ...
 * 
 */
@SuppressWarnings("all") public class TropixStorageAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://msi.umn.edu/tropix/storage/cagrid/TropixStorage";
	
	
	public TropixStorageAuthorization() {
	}
	...
	public static void authorizeExists() throws RemoteException {
		
		
	}
					
	public static void authorizePrepareDownload() throws RemoteException {
		
		
	}
					
	public static void authorizePrepareUpload() throws RemoteException {
		
		
	}
					
	public static void authorizeCanDownload() throws RemoteException {
		
		
	}
					
	public static void authorizeCanUpload() throws RemoteException {
		
		
	}
					
	public static void authorizeCanDelete() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("exists")){
			try{
				authorizeExists();
				return true;
			} catch (Exception e){
		...
		} else if(operation.getLocalPart().equals("prepareDownload")){
			try{
				authorizePrepareDownload();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("prepareUpload")){
			try{
				authorizePrepareUpload();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("canDownload")){
			try{
				authorizeCanDownload();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("canUpload")){
			try{
				authorizeCanUpload();
				return true;
			} catch (Exception e){
		...
		} else if(operation.getLocalPart().equals("canDelete")){
			try{
				authorizeCanDelete();
				return true;
			} catch (Exception e){
