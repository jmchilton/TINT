...
public class RequestResultTest {
  ...
  public void properties() {
    final RequestResult result = new RequestResult(new RequestId("moo", "cow"), "filename", "filedescription");
    assert result.getRequestId().equals(new RequestId("moo", "cow"));
    assert result.getFileName().equals("filename");
    assert result.getFileDescription().equals("filedescription");
  }
}
