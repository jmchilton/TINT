...
@Entity @DescriptionMessageCode(MessageCodeConstants.TRANSFERRING_FILES)
public class UploadFileDescription extends ActivityDescription implements Serializable, ConsumesStorageServiceUrl {
