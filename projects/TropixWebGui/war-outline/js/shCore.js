...
<html>
  ...
  <body class=\"dp-about\">
    <table cellspacing=\"0\">
      <tr>
        <td class=\"copy\">
          <p class=\"title\">dp.SyntaxHighlighter</div>
            <div class=\"para\">Version: {V}
          </p>
          <p>
            <a href=\"http://www.dreamprojections.com/syntaxhighlighter/?ref=about\" target=\"_blank\">
              http://www.dreamprojections.com/SyntaxHighlighter
            </a>
          </p>
          &copy;2004-2005 Alex Gorbatchev. All right reserved.
        </td>
      </tr>
      <tr>
        <td class=\"footer\">
          <input type=\"button\" class=\"close\" value=\"OK\" onClick=\"window.close()\"/>
        </td>
      </tr>
    </table>
  </body>
...
dp.sh.Toolbar.Commands={
  ...
  PrintSource:{
    ...
    func:function(_a,_b){
      ...
      _c.contentWindow.print();alert("Printing...");
  ...
  About:{
    ...
    func:function(_e){
      ...
      var doc=_f.document;dp.sh.Utils.CopyStyles(doc,window.document);
...
dp.sh.Highlighter.prototype.ProcessSmartTabs=function(_31){
  ...
  function ProcessLine(_3d,_3e){
    ...
    while((pos=_3d.indexOf(tab))!=-1){
      var _40=_3e-pos%_3e;_3d=InsertSpaces(_3d,pos,_40);
    }
    return _3d;
  }
...
dp.sh.HighlightAll=function(_5e,_5f,_60,_61,_62,_63){
  ...
  for(var i=0;i<_6f.length;i++){
    ...
    _70.firstLine=(_62==null)?parseInt(GetOptionValue("firstline",_78,1)):_62;_70.Highlight(_77[_72]);
