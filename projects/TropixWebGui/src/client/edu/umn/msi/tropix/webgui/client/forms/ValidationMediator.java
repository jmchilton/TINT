...
public class ValidationMediator {
  ...
  public void onValidation(final boolean isValid) {
    final Iterator<ValidationListener> iterator = this.validationListeners.iterator();
    while(iterator.hasNext()) {
      final ValidationListener listener = iterator.next();
      listener.onValidation(isValid);
    }
  }
}
