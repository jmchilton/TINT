 ...
 * </PRE>
 */
public interface CatalogSearchDetailsPanelConstants extends Constants {
  String lblServiceName();

  String lblAuthor();

  String lblDateCreated();

  String lblVersion();

  String lblDateLastModified();
  ...
  String lblServiceNameHelp();

  String lblAuthorHelp();

  String lblDateCreatedHelp();

  String lblVersionHelp();

  String lblDateLastModifiedHelp();

  String lblStatusHelp();

  String lblProviderHelp();

  String lblCategoryHelp();

  String lblSummaryHelp();

  String lblDescriptionHelp();

  String lblReferencesHelp();

  String lstStatusChoice0();

  String lstStatusChoice1();

  String lstProviderChoice0();

  String lstProviderChoice1();

  String lstProviderChoice2();

  String lstProviderChoice3();

  String lstProviderChoice4();
   ...
   * @return
   */
  String lblConceptDefinitionHelp();

  /**
   * @return
   */
  String lblDefinition();

  /**
   * @return
   */
  String lblObjectClassHelp();

  /**
   * @return
   */
  String lblObjectClass();

  /**
   * @return
   */
  String lblObjectProperty();

  /**
   * @return
   */
  String lblObjectPropertyHelp();

  /**
   * @return
   */
  String lblValueDomain();
