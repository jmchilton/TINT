 ...
 * </PRE>
 */
@RemoteServiceRelativePath("CatalogSearchService.rpc")
@GWTRequestMapping("/webgui/CatalogSearchService.rpc")
public interface CatalogSearch extends RemoteService {

  public static class Util {

    public static CatalogSearchAsync getInstance() {
      return (CatalogSearchAsync) GWT.create(CatalogSearch.class);
    }
  }

  List<ServiceBean> searchServices(String searchTerm);

  List<ServiceBean> advancedSearch(CustomQueryBean queryBean);
