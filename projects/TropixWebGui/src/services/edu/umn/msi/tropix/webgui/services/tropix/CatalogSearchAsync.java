 ...
 * </PRE>
 */
public interface CatalogSearchAsync {

  void searchServices(String searchTerm, AsyncCallback<List<ServiceBean>> callback);

  // public abstract void getHostAndPort(AsyncCallback callback);
  // public abstract void getUser(AsyncCallback callback);
  // public abstract void getPersonData(int start, int limit, String sort,
  // String dir, String[][] params, AsyncCallback callback);
  // public abstract void getKeyword(int start, int limit, String sort, String
  // dir, String[][] params, AsyncCallback callback);
  void advancedSearch(CustomQueryBean queryBean, AsyncCallback<List<ServiceBean>> callback);
}
