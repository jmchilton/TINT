...
public class LoginInfo implements Serializable {
  ...
  private List<String> authenticationSources;
  ...
  public void setAuthenticationServices(final List<String> authenticationSources) {
    this.authenticationSources = authenticationSources;
  }
