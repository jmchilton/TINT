...
public class Lists {
   ...
   * 
   * <p>
   * <b>Note:</b> if you need an immutable List, use {@link ImmutableList} instead.
   * 
   * <p>
   ...
   * <i>exact</i> size specified; equivalent to {@link ArrayList#ArrayList(int)}.
   * 
   * <p>
   * <b>Note:</b> if you know the exact size your list will be, consider using a fixed-size list ({@link Arrays#asList(Object[])}) or an
   * {@link ImmutableList} instead of a growable {@link ArrayList}.
   * 
   * <p>
   * <b>Note:</b> If you have only an <i>estimate</i> of the eventual size of the list, consider padding this estimate by a suitable amount, or simply
