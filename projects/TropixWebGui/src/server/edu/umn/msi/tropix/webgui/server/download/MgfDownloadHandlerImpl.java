...
@ManagedBean
@FileDownloadHandlerType("mgf")
class MgfDownloadHandlerImpl implements FileDownloadHandler {
  private final MgfDownloadHelper mgfDownloadHelper;

  @Inject
  MgfDownloadHandlerImpl(final MgfDownloadHelper mgfDownloadHelper) {
